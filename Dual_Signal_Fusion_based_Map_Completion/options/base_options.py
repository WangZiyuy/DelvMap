...
import os
import torch
from Dual_Signal_Fusion_based_Map_Completion import models
...
class BaseOptions:
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--net_trans', type=str, default='Unet')
        parser.add_argument('--lam', type=float, default=0.2)

        # parser.add_argument('--input_nc', type=int, default=11, help='# of input image channels: 3 for RGB and 1 for grayscale')
        ...
        parser.add_argument('--train_pattern', type=str, default='simple')
